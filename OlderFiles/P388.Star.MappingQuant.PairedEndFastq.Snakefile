...
############
configfile:"/fs/pool/pool-bcfngs/scripts/P388.config.yaml" # this is the path to the config file on the hpcl5002

## snakemake -nps /fs/pool/pool-bcfngs/scripts/P318.Star.MappingQuant.PairedEndFastq.Snakefile -j 10
